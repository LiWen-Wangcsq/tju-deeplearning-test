...
def train(model,optimizer,scheduler,criterion,train_loader,
    ...
    for e in range(epochs):
        ...
        if val_metrics['loss'] < valid_loss_min:
            ...
            torch.save(save_file, 'results/swinunet3d_cbam.pth')
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/data1/0_Brain_Seg/WLW/unet/data/BraTS2021/dataset')
    parser.add_argument('--train_txt', type=str, default='/data1/0_Brain_Seg/WLW/unet/data/BraTS2021/train.txt')
    parser.add_argument('--valid_txt', type=str, default='/data1/0_Brain_Seg/WLW/unet/data/BraTS2021/valid.txt')
    parser.add_argument('--test_txt', type=str, default='/data1/0_Brain_Seg/WLW/unet/data/BraTS2021/test.txt')
    parser.add_argument('--train_log', type=str, default='results/swinunet3dse_cnam.txt')
    parser.add_argument('--weights', type=str, default='results/swinunet3dse_cbam.pth')
    parser.add_argument('--save_path', type=str, default='checkpoint/swinunet3dse_cbam')
