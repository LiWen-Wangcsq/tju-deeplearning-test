...
# train
# train_set = {
#         'root': '/data1/0_Brain_Seg/WLW/unet/data/BraTS2021',  # 四个模态数据所在地址
#         'out': '/data1/0_Brain_Seg/WLW/unet/data/BraTS2021/dataset/',  # 预处理输出地址
#         'flist': '/data1/0_Brain_Seg/WLW/unet/data/BraTS2021/train.txt',  # 训练集名单（有标签）
#         }
train_set = {
        'root': '/data2/A0_MSD_Final_For_Paper/DATASET/nnUNet_raw/nnUNet_raw_data/Task82_BraTS_2020/MICCAI_BraTS2020_ValidationData',  # 四个模态数据所在地址
        'out': '/data1/0_Brain_Seg/WLW/unet/data/brats2020/dateset',  # 预处理输出地址
        'flist': '/data1/0_Brain_Seg/WLW/unet/data/brats2020/valid.txt',  # 训练集名单（有标签）
        }
...
def doit(dset):
    ...
    names = ['BraTS20_Validation_' + sub for sub in subjects]
