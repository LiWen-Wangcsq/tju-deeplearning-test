...
# 预处理输出地址
data_path = "/data1/0_Brain_Seg/WLW/unet/data/brats2020/dateset"
...
with open('/data1/0_Brain_Seg/WLW/unet/data/brats2020/train.txt','w') as f:
    f.write('\n'.join(train_ids))

with open('/data1/0_Brain_Seg/WLW/unet/data/brats2020/valid.txt','w') as f:
    f.write('\n'.join(val_ids))

with open('/data1/0_Brain_Seg/WLW/unet/data/brats2020/test.txt','w') as f:
    f.write('\n'.join(test_ids))
